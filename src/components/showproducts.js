...
export default function Showproduct(props){
  ...
  return   <div class='col-lg-3' style={{marginBottom:'20px',padding:'0px',border:'2px solid purple',borderRadius:'10px'}}>
              <div><img src={props.imgs[0]} class='img img-rounded' height="300px" width="100%" /></div>
              <div>Product ID: &nbsp;&nbsp; <b>{props._id}</b></div>              <br></br>
              <div><b>{props.name}</b></div>          <br></br>
              <div><p>Rs.&nbsp;<b>{props.price}</b></p></div>         <br></br>
              ...
              <br></br><br></br>
              <center><div><button class='btn btn-sm btn-danger' onClick={()=>props.removecartproduct(props._id)}>Remove From Cart</button></div></center>
        </div>
}
