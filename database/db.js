...
var orderSchema=new mongoose.Schema({email:String,cart:{type:Array,default:[]},price:Number,mode:String,payid:{type:String,default:null},status:{type:'String',default:'Yet to be dispatched'},timestamp:String})
